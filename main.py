...
def main():
    ...
    Working Hours = st.text_input('Worked_Time')
    ...
    if st.button('Productivity Test result'):
        Productivity = Labour_Prediction(Age, Designation, Experience, Working Hours, RemainingWorkingHours, OverTimeHours, ActualWorkingHours, BeatsPerMinute, BodyTemperature, Skin_Sensor, RR, MotionProductivity, MotionIndication, NoiseDetection )
